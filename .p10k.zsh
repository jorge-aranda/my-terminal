...
() {
  ...
  # Show username only in text terminal mode
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S %Z}'  # e.g. 21:37:00 CET
  # Alternatives:
  # typeset -g POWERLEVEL9K_TIME_FORMAT='%H:%M %Z' # 21:37 CET
  # typeset -g POWERLEVEL9K_TIME_FORMAT='%H:%M %z'  # numeric offset +0100
