# Generated by Powerlevel10k configuration wizard on 2026-02-21 at 22:16 CET.
...
() {
  ...
  # Custom icon.
  # Java version from jenv (Nerd Font icon)
  ...
  # Custom icon.
  # Python version from pyenv (Nerd Font icon)
  typeset -g POWERLEVEL9K_PYENV_VISUAL_IDENTIFIER_EXPANSION=$'🐍'  #
